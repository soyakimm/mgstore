...
<body>
   ...
   <div class="proAdminAdd-page">
        <div class="proAdminAdd-header">
            <div class="proAdminAdd-title"><h3>상품 수정</h3></div>
        </div>
   ...
   <form method="post" action="${ pageContext.servletContext.contextPath }/product/update"
            ...
            <div class="pro-regist-wrapper">
                <table>
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="proTitle" placeholder="상품명은 100자까지 입력 가능합니다." size="80" maxlength="100" value="${ product.proTitle }" required>
                        </td>
                    </tr>
                    <tr>
                        <th>판매가<span>&nbsp(필수)</span></th>
                        <td colspan="2">
                            <input type="text" name="price" value="${ product.price }" required>&nbsp원
                        </td>
                    </tr>
                    <tr>
                        <th>카테고리<span>&nbsp(필수)</span></th>
                        <td colspan="2">
                            <select name="superCategory" style="width: 300px; height: 20px;" value="${ product.proCateId }" required>
                            ...
                            <select name="subCategory" style="width: 300px; height: 20px;" value="${ product.proCateId }" required>
                    ...
                    <tr height="300">
                        <th>상품 설명</th>
                        <td colspan="2">
                            <textarea cols="100" rows="17" style="resize:none;" name="proContent" maxlength="2000" 
                            	placeholder="상품 설명은 2000자까지 입력 가능합니다." required>${ product.proContent }</textarea>
                        </td>
                    </tr>
                    <tr class="table-img">
