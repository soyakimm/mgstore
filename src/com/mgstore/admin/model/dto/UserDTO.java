package com.mgstore.admin.model.dto;
...
public class UserDTO {
	...
	/*일반회원 리스트조회*/
	public UserDTO(String userId, String userName, String phone, String userStatus) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.phone = phone;
	...
	/*일반회원 상세정보보기*/
	public UserDTO(String userId, String userName, String email, String phone, String address) {
		super();
		this.userId = userId;
		this.userName = userName;
		this.email = email;
